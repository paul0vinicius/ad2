...
Antes, vamos importar os dados referentes às eleições de 2014. Antes de utilizar os dados, é necessário fazer alguns ajustes, tais quais tratamento de NAs e alterar _factor_ para _character_.
...
eleicoes_filtradas <- eleicoes2014 %>%
  select(-nome, -sequencial_candidato, -numero_cadidato, -cargo, -partido, -UF, -setor_economico_receita)
...
Não, algumas variáveis servem apenas para identificar quem é o deputado, como um ID. Inclusive, estes campo são redundantes: O *numero_cadidato*, o *sequencial_cadidato*. O nome também não é úti nesse modelo
